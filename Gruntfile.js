  ...
  grunt.initConfig({
        ...
        files: [
          {
              ...
              dest: 'sphinx_quonext_theme/static/fonts/',
              filter: 'isFile'
          },
          {
              expand: true,
    ...
    sass: {
      dev: {
        ...
        files: [{
          ...
          cwd: 'sass',
          src: ['*.sass'],
          dest: 'sphinx_quonext_theme/static/css',
          ext: '.css'
        }]
      },
      build: {
    ...
    browserify: {
      dev: {
        ...
        src: ['js/*.js'],
        dest: 'sphinx_quonext_theme/static/js/theme.js'
      },
      build: {
        options: {
          external: ['jquery'],
    ...
    clean: {
      ...
      fonts: ["sphinx_quonext_theme/static/fonts"]
    },
    ...
    watch: {
      ...
      sphinx: {
        files: ['sphinx_quonext_theme/**/*', 'demo_docs/**/*.rst', 'demo_docs/**/*.py'],
